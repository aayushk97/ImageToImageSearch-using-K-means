package ImgSearch.clustering;

import imgsearch.indexing.Index;
import imgsearch.indexing.Indexer;
...
public class Cluster {
    ...
    public void calculateMean() {
        Date startDate = new Date(2014,04,1);
        Date endDate = new Date(2014,6,30);
        ...
        for (Index index : getMembers()) {
            ...
            System.out.println("Calulate Mean: ");
    ...
    public double getDistance(DenseMatrix64F r, DenseMatrix64F g, DenseMatrix64F b) {
        ...
        //System.out.println(rdist+" : "+gdist+" : "+bdist);
        double dist = Math.sqrt(rsum) + Math.sqrt(gsum) + Math.sqrt(bsum);
        return dist / 3;
    ...
    public List<Index> getMembers() {
        ...
        System.out.println("a"+i+members.size()+": "+members.toString());
        i++;
        return members;
    }
